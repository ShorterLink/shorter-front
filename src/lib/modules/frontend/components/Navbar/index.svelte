	...
	<div class="container main-nav">
		...
		<div class="main-nav-end">
			...
			<button class="theme-switcher gray-circle-btn" type="button" title="Switch theme">
				...
				<i class="sun-icon" data-feather="sun" aria-hidden="true" />
				<i class="moon-icon" data-feather="moon" aria-hidden="true" />
			</button>
						...
						<a href="##">
							...
							<div class="notification-dropdown-text">
								...
								<span class="notification-dropdown__subtitle"
									>The system has been successfully upgraded. Read more here.</span
								>
							</div>
						</a>
					</li>
					<li>
						<a href="##">
							...
							<div class="notification-dropdown-text">
								...
								<span class="notification-dropdown__subtitle"
									>Unnecessary caches take up a lot of memory space and interfere ...</span
								>
							</div>
						</a>
					</li>
